 ...
 *  used for maintaining a constant function prototype.
 ...
 * @info: Structure that holds potential arguments, ensuring
 * a consistent function prototype.
 * Return: Exits the shell with the provided exit status
 ...
 * @info: Structure that stores potential arguments, ensuring
 *  a consistent function prototype.
