 ...
 * @info: Struc having potential arg. 
...
/**
 * _myhelp - transforms recent dir of the process
 * @info: structure having  potential arguments. Used for holding
