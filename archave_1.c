...
/**
 * write_history - Attach to an existing history file.
 * @info: Param structure.
 *
...
/**
 * read_history - records history file.
 * @info: param structure.
 *
...
/**
 * build_history_list - puts an entry to the history linked list.
 * @info: Strut having potential arguments. Used to maintain
 * @buf: Buffer.
